...
import io.ktor.client.engine.ohos.OhosClientEngineConfig
...
internal suspend fun HttpRequestData.toCurlRequest(config: OhosClientEngineConfig): CurlRequestData = CurlRequestData(
    url = url.toString(),
    method = method.value,
